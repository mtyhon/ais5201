...
class CSNDataset(Dataset):
    ...
    def __init__(self, data_file, dataset, x_mean=1., x_std=1., line_mask=None, max_idx = None):
    ...
    def __getitem__(self, idx):
        ...
        return {'x':x[:self.max_idx], 'x_err':x_err[:self.max_idx], 'x_msk':x_msk[:self.max_idx], 'y':y[:self.max_idx], 'snr':snr[:self.max_idx]}
